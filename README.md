...
|---|---|---|
| **JornadaTrack** | Sistema web de controle de ponto e gestão de RH | Lovable, Supabase |
| **Processador de NFe Fiscal** | Automação de leitura e processamento de notas fiscais | Python |
| **Planilha Clean** | Ferramenta desktop de deduplicação de dados | Python, Tkinter |
| **Monitor Ubiquiti** | Automação de monitoramento de rede | n8n |
| **Portfólio 3D** | Portfólio pessoal com animações 3D interativas | HTML/CSS/JS |

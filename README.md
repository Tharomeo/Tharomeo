...
Developer focused on **automation, applied AI and web development**. I like building tools that solve real problems — from scratch, with full ownership.
...
|---|---|---|
| **JornadaTrack** | Web-based time tracking and HR management system | Lovable, Supabase |
| **Fiscal NFe Processor** | Automation for reading and processing tax invoices | Python |
| **Planilha Clean** | Desktop tool for spreadsheet deduplication | Python, Tkinter |
| **Ubiquiti Monitor** | Automated network device monitoring | n8n |
| **3D Portfolio** | Personal portfolio with interactive 3D animations | HTML/CSS/JS |
